...
DOCUMENTATION = r"""
---
module: rafay_catalog
short_description: Manage Rafay workload catalog
description:
  - Create, update, and delete Rafay catalog resources.
...
options:
  ...
  description:
    ...
    type: str
  items:
    description: The items of the resource.
    type: list
    elements: dict
  state:
...
EXAMPLES = r"""
- name: Manage catalog
  stevefulme1.rafay.rafay_catalog:
    name: my-catalog
    state: present
"""
...
RETURN = r"""
resource:
  description: The catalog resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/catalog/{name}'.format(project=project, name=name, **module.params)
