...
DOCUMENTATION = r"""
---
module: rafay_network_policy
short_description: Manage Rafay network policies
description:
  - Create, update, and delete Rafay network policy resources.
...
EXAMPLES = r"""
- name: Manage network policy
  stevefulme1.rafay.rafay_network_policy:
    name: my-network_policy
    state: present
"""

RETURN = r"""
resource:
  description: The network_policy resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/cluster/{cluster}/networkpolicy/{name}'.format(project=project, name=name, **module.params)
