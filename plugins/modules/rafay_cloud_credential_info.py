...
DOCUMENTATION = r"""
---
module: rafay_cloud_credential_info
short_description: Get Rafay cloud credential information
description:
  - Retrieve information about Rafay cloud credential resources.
...
EXAMPLES = r"""
- name: Get all cloud credentials
  stevefulme1.rafay.rafay_cloud_credential_info:

- name: Get specific cloud credential
  stevefulme1.rafay.rafay_cloud_credential_info:
...
RETURN = r"""
resources:
  description: List of cloud credential resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/cloudcredential/'.format(project=project)
