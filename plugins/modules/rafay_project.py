...
short_description: Manage Rafay projects
description:
  - Create, update, and delete Rafay project resources.
...
RETURN = r"""
resource:
  description: The project resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/auth/v3/project/{name}'.format(project=project, name=name, **module.params)
