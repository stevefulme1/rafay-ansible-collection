...
DOCUMENTATION = r"""
---
module: rafay_sso_info
short_description: Get Rafay SSO information
description:
  - Retrieve information about Rafay SSO resources.
...
EXAMPLES = r"""
- name: Get all SSO configurations
  stevefulme1.rafay.rafay_sso_info:

- name: Get specific SSO configuration
  stevefulme1.rafay.rafay_sso_info:
    name: my-sso
"""
...
RETURN = r"""
resources:
  description: List of SSO resources.
  type: list
  returned: always
"""
