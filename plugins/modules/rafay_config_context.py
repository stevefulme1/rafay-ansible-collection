...
DOCUMENTATION = r"""
---
module: rafay_config_context
short_description: Manage Rafay config contexts
description:
  - Create, update, and delete Rafay config context resources.
...
options:
  name:
    ...
    required: true
  variables:
    description: The variables of the resource.
    type: dict
  state:
...
EXAMPLES = r"""
- name: Manage config context
  stevefulme1.rafay.rafay_config_context:
    name: my-config_context
    state: present
"""

RETURN = r"""
resource:
  description: The config_context resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/eaas/v3/project/{project}/configcontext/{name}'.format(project=project, name=name, **module.params)
