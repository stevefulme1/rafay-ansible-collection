...
DOCUMENTATION = r"""
---
module: rafay_backup_location_info
short_description: Get Rafay backup location information
description:
  - Retrieve information about Rafay backup location resources.
...
EXAMPLES = r"""
- name: Get all backup locations
  stevefulme1.rafay.rafay_backup_location_info:

- name: Get specific backup location
  stevefulme1.rafay.rafay_backup_location_info:
...
RETURN = r"""
resources:
  description: List of backup location resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/backuplocation/'.format(project=project)
