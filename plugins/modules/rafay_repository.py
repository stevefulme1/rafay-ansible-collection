...
DOCUMENTATION = r"""
---
module: rafay_repository
short_description: Manage Rafay Git and Helm repositories
description:
  - Create, update, and delete Rafay repository resources.
...
options:
  name:
    ...
    required: true
  repo_type:
    description: The repo type of the resource.
    type: str
    choices: ['git', 'helm']
  endpoint:
...
- name: Manage repository
  stevefulme1.rafay.rafay_repository:
    name: my-repository
    state: present
"""
...
RETURN = r"""
resource:
  description: The repository resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    argument_spec.update(
        ...
        repo_type=dict(type='str', choices=['git', 'helm']),
    ...
    path = '/infra/v3/project/{project}/repository/{name}'.format(project=project, name=name, **module.params)
