...
DOCUMENTATION = r"""
---
module: rafay_gpu_instance_info
short_description: Get Rafay GPU instance information
description:
  - Retrieve information about Rafay GPU instance resources.
...
EXAMPLES = r"""
- name: Get all GPU instances
  stevefulme1.rafay.rafay_gpu_instance_info:

- name: Get specific GPU instance
  stevefulme1.rafay.rafay_gpu_instance_info:
...
RETURN = r"""
resources:
  description: List of GPU instance resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/gpuaas/v3/project/{project}/instance/'.format(project=project)
