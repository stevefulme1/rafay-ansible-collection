...
DOCUMENTATION = r"""
---
module: rafay_pipeline_info
short_description: Get Rafay pipeline information
description:
  - Retrieve information about Rafay pipeline resources.
...
- name: Get all pipelines
  stevefulme1.rafay.rafay_pipeline_info:
...
def main():
    ...
    path = '/infra/v3/project/{project}/pipeline/'.format(project=project)
