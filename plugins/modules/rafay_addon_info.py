...
DOCUMENTATION = r"""
---
module: rafay_addon_info
short_description: Get Rafay addon information
description:
  - Retrieve information about Rafay addon resources.
...
EXAMPLES = r"""
- name: Get all addons
  stevefulme1.rafay.rafay_addon_info:
...
RETURN = r"""
resources:
  description: List of addon resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/addon/'.format(project=project)
