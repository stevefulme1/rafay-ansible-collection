...
DOCUMENTATION = r"""
---
module: rafay_backup_policy
short_description: Manage Rafay backup policies
description:
  - Create, update, and delete Rafay backup policy resources.
...
options:
  name:
    ...
    required: true
  schedule:
    description: The schedule of the resource.
    type: str
  retention_days:
    description: The retention days of the resource.
    type: int
    default: 30
  include_pvs:
    description: The include pvs of the resource.
    type: bool
    default: true
  namespaces:
...
RETURN = r"""
resource:
  description: The backup_policy resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/backuppolicy/{name}'.format(project=project, name=name, **module.params)
