...
DOCUMENTATION = r"""
---
module: rafay_backup_job
short_description: Manage Rafay backup jobs
description:
  - Create, update, and delete Rafay backup job resources.
...
options:
  ...
  cluster:
    ...
    required: true
  policy:
    description: The policy of the resource.
    type: str
  state:
...
RETURN = r"""
resource:
  description: The backup_job resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/cluster/{cluster}/backup/{name}'.format(project=project, name=name, **module.params)
