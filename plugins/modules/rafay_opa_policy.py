...
DOCUMENTATION = r"""
---
module: rafay_opa_policy
short_description: Manage Rafay OPA/Gatekeeper policies
description:
  - Create, update, and delete Rafay opa policy resources.
...
options:
  name:
    ...
    required: true
  template_name:
    description: The template name of the resource.
    type: str
  parameters:
    description: The parameters of the resource.
    type: dict
  enforcement:
    description: The enforcement of the resource.
    type: str
    choices: ['audit', 'deny']
  state:
...
EXAMPLES = r"""
- name: Manage opa policy
  stevefulme1.rafay.rafay_opa_policy:
    name: my-opa_policy
    state: present
"""
...
RETURN = r"""
resource:
  description: The opa_policy resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    argument_spec.update(
        ...
        enforcement=dict(type='str', choices=['audit', 'deny']),
    ...
    path = '/security/v3/project/{project}/opapolicy/{name}'.format(project=project, name=name, **module.params)
