...
DOCUMENTATION = r"""
---
module: rafay_blueprint
short_description: Manage Rafay cluster blueprints
description:
  - Create, update, and delete Rafay blueprint resources.
...
- name: Manage blueprint
  stevefulme1.rafay.rafay_blueprint:
    name: my-blueprint
    state: present
"""
...
RETURN = r"""
resource:
  description: The blueprint resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/blueprint/{name}'.format(project=project, name=name, **module.params)
