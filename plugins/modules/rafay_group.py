...
---
module: rafay_group
short_description: Manage Rafay groups
description:
  - Create, update, and delete Rafay group resources.
...
RETURN = r"""
resource:
  description: The group resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/auth/v3/group/{name}'.format(project=project, name=name, **module.params)
