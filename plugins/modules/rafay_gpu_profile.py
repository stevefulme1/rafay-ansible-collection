...
DOCUMENTATION = r"""
---
module: rafay_gpu_profile
short_description: Manage Rafay GPU compute profiles
description:
  - Create, update, and delete Rafay gpu profile resources.
...
options:
  name:
    ...
    required: true
  gpu_type:
    description: The gpu type of the resource.
    type: str
  allocation:
    description: The allocation of the resource.
    type: str
    choices: ['dedicated', 'shared', 'fractional']
  count:
...
RETURN = r"""
resource:
  description: The gpu_profile resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    argument_spec.update(
        ...
        allocation=dict(type='str', choices=['dedicated', 'shared', 'fractional']),
        count=dict(type='int'),
    ...
    path = '/gpuaas/v3/project/{project}/computeprofile/{name}'.format(project=project, name=name, **module.params)
