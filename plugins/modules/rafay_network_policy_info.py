...
DOCUMENTATION = r"""
---
module: rafay_network_policy_info
short_description: Get Rafay network policy information
description:
  - Retrieve information about Rafay network policy resources.
...
EXAMPLES = r"""
- name: Get all network policies in a cluster
  stevefulme1.rafay.rafay_network_policy_info:
    cluster: my-cluster

- name: Get specific network policy
  stevefulme1.rafay.rafay_network_policy_info:
    cluster: my-cluster
...
RETURN = r"""
resources:
  description: List of network policy resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/cluster/{cluster}/networkpolicy/'.format(project=project, cluster=cluster)
