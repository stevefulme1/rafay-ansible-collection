...
DOCUMENTATION = r"""
---
module: rafay_cluster_info
short_description: Get Rafay cluster information
description:
  - Retrieve information about Rafay cluster info resources.
...
- name: Get cluster info
  stevefulme1.rafay.rafay_cluster_info:
    name: my-cluster_info
"""

RETURN = r"""
resources:
  description: List of cluster_info resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/cluster/'.format(project=project)
