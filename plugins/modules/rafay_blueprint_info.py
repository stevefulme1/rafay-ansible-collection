...
DOCUMENTATION = r"""
---
module: rafay_blueprint_info
short_description: Get Rafay blueprint information
description:
  - Retrieve information about Rafay blueprint info resources.
...
EXAMPLES = r"""
- name: Get blueprint info
  stevefulme1.rafay.rafay_blueprint_info:
    name: my-blueprint_info
"""

RETURN = r"""
resources:
  description: List of blueprint_info resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/blueprint/'.format(project=project)
