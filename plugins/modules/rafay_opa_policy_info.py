...
DOCUMENTATION = r"""
---
module: rafay_opa_policy_info
short_description: Get Rafay OPA policy information
description:
  - Retrieve information about Rafay OPA policy resources.
...
- name: Get all OPA policies
  stevefulme1.rafay.rafay_opa_policy_info:

- name: Get specific OPA policy
  stevefulme1.rafay.rafay_opa_policy_info:
    name: my-opa-policy
"""
...
RETURN = r"""
resources:
  description: List of OPA policy resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/security/v3/project/{project}/opapolicy/'.format(project=project)
