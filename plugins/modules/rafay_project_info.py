...
DOCUMENTATION = r"""
---
module: rafay_project_info
short_description: Get Rafay project information
description:
  - Retrieve information about Rafay project resources.
...
- name: Get all projects
  stevefulme1.rafay.rafay_project_info:
