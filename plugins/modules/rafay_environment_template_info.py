...
DOCUMENTATION = r"""
---
module: rafay_environment_template_info
short_description: Get Rafay environment template information
description:
  - Retrieve information about Rafay environment template resources.
...
EXAMPLES = r"""
- name: Get all environment templates
  stevefulme1.rafay.rafay_environment_template_info:

- name: Get specific environment template
  stevefulme1.rafay.rafay_environment_template_info:
    name: my-environment-template
"""

RETURN = r"""
resources:
  description: List of environment template resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/eaas/v3/project/{project}/environmenttemplate/'.format(project=project)
