...
DOCUMENTATION = r"""
---
module: rafay_config_context_info
short_description: Get Rafay config context information
description:
  - Retrieve information about Rafay config context resources.
...
EXAMPLES = r"""
- name: Get all config contexts
  stevefulme1.rafay.rafay_config_context_info:

- name: Get specific config context
  stevefulme1.rafay.rafay_config_context_info:
...
RETURN = r"""
resources:
  description: List of config context resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/eaas/v3/project/{project}/configcontext/'.format(project=project)
