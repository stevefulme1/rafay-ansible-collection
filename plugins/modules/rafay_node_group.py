...
DOCUMENTATION = r"""
---
module: rafay_node_group
short_description: Manage node groups in Rafay clusters
description:
  - Create, update, and delete Rafay node group resources.
...
options:
  ...
  instance_type:
    ...
    type: str
  min_count:
    description: The min count of the resource.
    type: int
    default: 1
  max_count:
    description: The max count of the resource.
    type: int
    default: 3
  disk_size:
...
RETURN = r"""
resource:
  description: The node_group resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    argument_spec.update(
        ...
        max_count=dict(type='int', default=3),
    ...
    path = '/infra/v3/project/{project}/cluster/{cluster}/nodegroup/{name}'.format(project=project, name=name, **module.params)
