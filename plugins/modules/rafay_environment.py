...
DOCUMENTATION = r"""
---
module: rafay_environment
short_description: Manage Rafay developer environments
description:
  - Create, update, and delete Rafay environment resources.
...
options:
  name:
    ...
    required: true
  template:
    description: The template of the resource.
    type: str
  variables:
...
- name: Manage environment
  stevefulme1.rafay.rafay_environment:
    name: my-environment
    state: present
"""
...
RETURN = r"""
resource:
  description: The environment resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/eaas/v3/project/{project}/environment/{name}'.format(project=project, name=name, **module.params)
