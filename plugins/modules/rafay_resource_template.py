...
DOCUMENTATION = r"""
---
module: rafay_resource_template
short_description: Manage Rafay resource templates
description:
  - Create, update, and delete Rafay resource template resources.
...
options:
  ...
  template_type:
    description: The template type of the resource.
    type: str
...
EXAMPLES = r"""
- name: Manage resource template
  stevefulme1.rafay.rafay_resource_template:
    name: my-resource_template
    state: present
"""

RETURN = r"""
resource:
  description: The resource_template resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    argument_spec.update(
        ...
        template_type=dict(type='str', choices=['terraform', 'kubernetes']),
    ...
    path = '/eaas/v3/project/{project}/resourcetemplate/{name}'.format(project=project, name=name, **module.params)
