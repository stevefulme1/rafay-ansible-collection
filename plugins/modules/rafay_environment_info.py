...
DOCUMENTATION = r"""
---
module: rafay_environment_info
short_description: Get Rafay environment information
description:
  - Retrieve information about Rafay environment resources.
...
- name: Get all environments
  stevefulme1.rafay.rafay_environment_info:
...
def main():
    ...
    path = '/eaas/v3/project/{project}/environment/'.format(project=project)
