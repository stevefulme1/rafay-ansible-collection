...
DOCUMENTATION = r"""
---
module: rafay_secret_store_info
short_description: Get Rafay secret store information
description:
  - Retrieve information about Rafay secret store resources.
...
- name: Get all secret stores
  stevefulme1.rafay.rafay_secret_store_info:

- name: Get specific secret store
  stevefulme1.rafay.rafay_secret_store_info:
...
RETURN = r"""
resources:
  description: List of secret store resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/secretstore/'.format(project=project)
