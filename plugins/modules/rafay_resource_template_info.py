...
DOCUMENTATION = r"""
---
module: rafay_resource_template_info
short_description: Get Rafay resource template information
description:
  - Retrieve information about Rafay resource template resources.
...
EXAMPLES = r"""
- name: Get all resource templates
  stevefulme1.rafay.rafay_resource_template_info:

- name: Get specific resource template
  stevefulme1.rafay.rafay_resource_template_info:
...
RETURN = r"""
resources:
  description: List of resource template resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/eaas/v3/project/{project}/resourcetemplate/'.format(project=project)
