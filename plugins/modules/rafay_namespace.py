...
DOCUMENTATION = r"""
---
module: rafay_namespace
short_description: Manage Rafay namespaces
description:
  - Create, update, and delete Rafay namespace resources.
...
options:
  ...
  cluster:
    ...
    required: true
  resource_quota:
    description: The resource quota of the resource.
    type: dict
  limit_range:
    description: The limit range of the resource.
    type: dict
  labels:
...
RETURN = r"""
resource:
  description: The namespace resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    argument_spec.update(
        ...
        resource_quota=dict(type='dict'),
        limit_range=dict(type='dict'),
    ...
    path = '/infra/v3/project/{project}/cluster/{cluster}/namespace/{name}'.format(project=project, name=name, **module.params)
