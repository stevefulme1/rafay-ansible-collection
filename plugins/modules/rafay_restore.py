...
DOCUMENTATION = r"""
---
module: rafay_restore
short_description: Restore Rafay backups
description:
  - Create, update, and delete Rafay restore resources.
...
options:
  name:
    ...
    required: true
  backup_name:
    description: The backup name of the resource.
    type: str
    required: true
  target_cluster:
    description: The target cluster of the resource.
    type: str
    required: true
  state:
...
RETURN = r"""
resource:
  description: The restore resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    argument_spec.update(
        ...
        target_cluster=dict(type='str', required=True),
    ...
    path = '/infra/v3/project/{project}/restore/{name}'.format(project=project, name=name, **module.params)
