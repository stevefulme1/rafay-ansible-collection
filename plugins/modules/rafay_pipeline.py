...
DOCUMENTATION = r"""
---
module: rafay_pipeline
short_description: Manage Rafay GitOps pipelines
description:
  - Create, update, and delete Rafay pipeline resources.
...
- name: Manage pipeline
  stevefulme1.rafay.rafay_pipeline:
    name: my-pipeline
    state: present
"""
...
RETURN = r"""
resource:
  description: The pipeline resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/pipeline/{name}'.format(project=project, name=name, **module.params)
