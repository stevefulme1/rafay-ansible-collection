...
DOCUMENTATION = r"""
---
module: rafay_catalog_info
short_description: Get Rafay catalog information
description:
  - Retrieve information about Rafay catalog resources.
...
- name: Get all catalogs
  stevefulme1.rafay.rafay_catalog_info:

- name: Get specific catalog
  stevefulme1.rafay.rafay_catalog_info:
    name: my-catalog
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/catalog/'.format(project=project)
