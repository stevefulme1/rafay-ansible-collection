...
DOCUMENTATION = r"""
---
module: rafay_repository_info
short_description: Get Rafay repository information
description:
  - Retrieve information about Rafay repository resources.
...
- name: Get all repositories
  stevefulme1.rafay.rafay_repository_info:
...
def main():
    ...
    path = '/infra/v3/project/{project}/repository/'.format(project=project)
