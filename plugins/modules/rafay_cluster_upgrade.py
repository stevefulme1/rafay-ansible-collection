...
DOCUMENTATION = r"""
---
module: rafay_cluster_upgrade
short_description: Upgrade Rafay cluster Kubernetes version
description:
  - Create, update, and delete Rafay cluster upgrade resources.
...
options:
  name:
    ...
    required: true
  target_version:
    description: The target version of the resource.
    type: str
    required: true
...
EXAMPLES = r"""
- name: Manage cluster upgrade
  stevefulme1.rafay.rafay_cluster_upgrade:
    name: my-cluster_upgrade
    state: present
"""

RETURN = r"""
resource:
  description: The cluster_upgrade resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/cluster/{name}/upgrade'.format(project=project, name=name, **module.params)
