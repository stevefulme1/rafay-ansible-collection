...
DOCUMENTATION = r"""
---
module: rafay_gpu_instance
short_description: Manage Rafay GPU instances
description:
  - Create, update, and delete Rafay gpu instance resources.
...
EXAMPLES = r"""
- name: Manage gpu instance
  stevefulme1.rafay.rafay_gpu_instance:
    name: my-gpu_instance
    state: present
"""

RETURN = r"""
resource:
  description: The gpu_instance resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/gpuaas/v3/project/{project}/instance/{name}'.format(project=project, name=name, **module.params)
