...
DOCUMENTATION = r"""
---
module: rafay_cost_profile
short_description: Manage Rafay cost allocation profiles
description:
  - Create, update, and delete Rafay cost profile resources.
...
EXAMPLES = r"""
- name: Manage cost profile
  stevefulme1.rafay.rafay_cost_profile:
    name: my-cost_profile
    state: present
"""

RETURN = r"""
resource:
  description: The cost_profile resource object.
  type: dict
  returned: on success
"""
...
def main():
    ...
    path = '/cost/v3/project/{project}/costprofile/{name}'.format(project=project, name=name, **module.params)
