...
DOCUMENTATION = r"""
---
module: rafay_backup_policy_info
short_description: Get Rafay backup policy information
description:
  - Retrieve information about Rafay backup policy resources.
...
EXAMPLES = r"""
- name: Get all backup policies
  stevefulme1.rafay.rafay_backup_policy_info:

- name: Get specific backup policy
  stevefulme1.rafay.rafay_backup_policy_info:
...
RETURN = r"""
resources:
  description: List of backup policy resources.
  type: list
  returned: always
"""
...
def main():
    ...
    path = '/infra/v3/project/{project}/backuppolicy/'.format(project=project)
